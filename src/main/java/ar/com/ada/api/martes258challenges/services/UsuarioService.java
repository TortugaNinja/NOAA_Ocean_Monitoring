package ar.com.ada.api.martes258challenges.services;
...
import ar.com.ada.api.martes258challenges.entities.*;
...
import ar.com.ada.api.martes258challenges.repositories.*;
import ar.com.ada.api.martes258challenges.security.Crypto;
import ar.com.ada.api.martes258challenges.sistema.comm.EmailService;
...
public class UsuarioService {
    ...
    public Usuario crearUsuario(TipoUsuarioEnum tipoUsuario, String nombre, int pais, TipoDocuEnum tipoDocumento,
        ...
        //Aca enviamos email.
        emailService.SendEmail(usuario.getEmail(), "Curso Pinturillo: Registracion exitossa!!!", "Hola "+ usuario.getUsername() + ", bienvenida al sistema de martes258challenges");
        return usuario;
